...
const string UnityPath = @"C:\Program Files\Unity\Hub\Editor\2021.3.15f1\Editor\Unity.exe";
const string UnityBuildMethod = "Editor.Builder.BuildWebGl";
string ProjectFolderPath = $"./src/{ProjectName}";
...
string SearchingBuildFolderPattern = @"^.{0,}_" + ProjectName + "_.{0,}$";
